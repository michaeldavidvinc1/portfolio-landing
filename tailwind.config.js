  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-shape2_light': 'url(/hero/shape-2-light.svg)',
        'hero-shape2_dark': 'url(/hero/shape-2-dark.svg)',
        'dots-light' : 'url(/dots-light.svg)',
        'dots-dark' : 'url(/dots-dark.svg)',
        'about-shape_light' : 'url(/about/shape-light.svg)',
        'about-shape_dark' : 'url(/about/shape-dark.svg)',
